...
cjurl=[
    ...
    'shendu':0,
    #类似网址入口正则(精确要进入采集的网址)
    'link_tezheng':['/\?kw\=&p\=0&bl\=6&el\=6&ds%5B%5D\=1&py\=1&pl\=0&sort\=1&suffix%5B%5D\=com&dt\=1&date\=1&pagesize\=30&st\=1&page\=\d'],
    #目标网址正则
    'mb_url_reg':'<a[^><\n]*?href=["|\']?([^><\n]*?(?:/\?kw\=&p\=0&bl\=6&el\=6&ds%5B%5D\=1&py\=1&pl\=0&sort\=1&suffix%5B%5D\=com&dt\=1&date\=1&pagesize\=30&st\=1&page\=\d)[^><\n]*?)["|\']?[^><\n]*?>.*?</a>',
    #目标内容正则
